...
-- What is the trend of number of orders by quarter? 
-- The trend is a declining number of orders per quarter.
...
-- What is the trend of revenue and orders by quarter? Both are decreasing probably due to longer shipping times and higher customer dissatisfaction.
select quarter_number, round(sum(o.quantity * p.vehicle_price), 2) as total_revenue,
